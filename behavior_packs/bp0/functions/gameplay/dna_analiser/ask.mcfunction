...
execute @e[type=armor_stand,name=current,scores={ener=..9}] ~ ~ ~ event entity @e[type=gameplay:dna_analiser] evt:deny

### If enought energy : 
execute @e[type=armor_stand,name=current,scores={ener=10..}] ~ ~ ~ event entity @e[type=gameplay:dna_analiser] evt:accept
